<section id="dashboard" class="team pt-4" style="background-color:#e2e2e2;">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-evenly justify-content-md-center justify-content-sm-center mt-4 pt-4">
            ...
            <div onclick="getPercentage(0,0,<?= $id_pks ?>,$(this).find('p.text-main').text())"
                class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover rounded bg-light p-3 curpo me-3 me-sm-4 mb-2 ms-3">
                <div class="member bg-light nb-shadow">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
            ...
            <div onclick="getPercentage(1,40,<?= $id_pks ?>,$(this).find('p.text-main').text())"
                class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover rounded bg-light p-3 curpo me-3 me-sm-4 mb-2 ms-3">
                <div class="member bg-light nb-shadow">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
            ...
            <div onclick="getPercentage(41,60,<?= $id_pks ?>,$(this).find('p.text-main').text())"
                class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover rounded bg-light p-3 curpo me-3 me-sm-4 mb-2 ms-3">
                <div class="member bg-light nb-shadow">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
            ...
            <div onclick="getPercentage(61,99,<?= $id_pks ?>,$(this).find('p.text-main').text())"
                class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover rounded bg-light p-3 curpo me-3 me-sm-4 mb-2 ms-3">
                <div class="member bg-light nb-shadow">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
            ...
            <div onclick="getPercentage(100,100,<?= $id_pks ?>,$(this).find('p.text-main').text())"
                class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover rounded bg-light p-3 curpo me-3 me-sm-4 mb-2 ms-3">
                <div class="member bg-light nb-shadow">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
            ...
            <div onclick="" class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mt-4 zoom-hover  nb-shadow">
                <a href="<?php echo site_url('user/ubah_info_stok') ?>">
                    <div style="height:100%"
                        class="member d-flex flex-column align-items-center bg-light p-0 overflow-hidden "
                    ...
                    <div style="height:100%"
                        ...
                        <div style="height:25vh" class="p-3 d-flex align-items-center text-start">
                            <i style="font-size: 4rem;"
                                class="bi bi-house fw-bold text-main mt-3 zoom-hover nb-shadow"></i>
                        </div>
                        <div style="height:100%" class="bg-secondary w-100 mt-4 p-3 d-flex align-items-center ">
            ...
            <div onclick="" class="col-xl-2 col-lg-3 col-md-4 col-9 mt-4 zoom-hover nb-shadow">
                <a href="<?php echo site_url('user/logout') ?>">
                    <div style="height:100%"
                        ...
                        <div style="height:25vh" class="p-3 d-flex align-items-center text-start">
                            <i style="font-size: 4rem;"
                                class="bi bi-power fw-bold text-danger mt-3 zoom-hover nb-shadow"></i>
                        </div>
                        <div style="height:100%" class="bg-secondary w-100 mt-4 p-3 d-flex align-items-center ">
