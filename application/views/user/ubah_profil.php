                    ...
                    <div class="row w-90">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 d-flex justify-content-lg-end">
                            <div class="float-lg-end">
                                ...
                                <div class="p-1 mb-2">
                                    <img class="rounded w-100 mb-2 no-hover zoom-hover nb-shadow" src="<?php echo base_url() ?>assets/img/profile_picture/<?php echo $this->session->userdata['profile']; ?>" alt="" srcset="">
                                    <input type="file" name="berkas" class="form-control" id="fp">
                                </div>
                            </div>
<div class="d-xl-block d-lg-block d-md-block d-sm-none ms-4 d-none" style="height: 100%;width:1px;background-color:lightgray; transform:scaleY(1.015)"></div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group mt-3">
                                ...
                                <input value="<?php echo $this->session->userdata['nama'] ?>" type="text" name="nama" class="form-control" id="name" required>
                                <?php echo form_error('nama', '<div class="text-danger"><small>', '</small></div>'); ?>
                            </div>

                            <div class="form-group mt-3">
                                <label class="float-start" for="">E-mail</label>
                                <input style="pointer-events:none" value="<?php echo $this->session->userdata['email'] ?>" type="email" name="email" class="form-control" id="mail">
