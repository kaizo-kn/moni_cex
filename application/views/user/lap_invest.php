                        ...
                        foreach ($weeklist as $key => $value) {
                            ...
                            if (isset($persentase_progress[$weekname])) {
                                ...
                                if (isset($bukti)) {
                                    ...
                                    echo "<td style='white-space:nowrap;text-align:center' class='$weeknum curpo'>
                                        <div style='width:60px; margin-left:2px'><a
                                                onclick='setDownloadImage(`$foto_bukti`)' href='$foto_bukti'
                                                data-gallery='portfolioGallery'
                                                class='portfolio-lightbox preview-link text-start ps-0'
                                                title='$bukti'>$persentase_s
                                            </a></div>
                                    </td>";
                                } else {
                                    echo "<td style='white-space:nowrap;text-align:center;cursor:default'
                                        class='$weeknum text-secondary'>
                                        <div style='width:60px; margin-left:2px'>$persentase_s</div>
                                    </td>";
                                }
                                $counter++;
                            } else {
...
<script>
    ...
    function fireHist(id_pekerjaan) {
        ...
        $.ajax({
            url: bsp + "index.php/user/ajax_get_history",
            type: "POST",
            dataType: 'json',
            data: {
