<section id="dashboard" class="team pt-4" style="background-color:light-grey;">
    <div class="container-fluid">
        <div class="h-100">
            ...
            <div class="row justify-content-center">
                <div onclick="" class="col-3 mt-4 zoom-hover member">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
                            <i class="bi bi-gear fs-1 fw-bold text-secondary"></i>
                        </div>
                        <div class="col-8">
                            <p class="main-text-color fs-5 fw-bolder text-start">
                                JUMLAH PAKET PEKERJAAN
                            </p>
                        </div>
                    </div>
                    <div class="d-inline main-text-color mt-3">
            ...
            <div class="row justify-content-evenly">
                <div onclick="" class="col-xl-2 col-lg-2 col-md-4 col-sm-4 mt-4 zoom-hover member">
                    <div class="row justify-content-start mb-2">
                        <div class="col-4">
                            <i class="bi bi-gear fs-1 fw-bold text-secondary"></i>
                        </div>
                        <div class="col-8">
                            <p class="main-text-color fw-bolder text-start">
                                PROGRESS DI PKS
                            </p>
                        </div>
                    </div>
            ...
            <div class="row ">
                ...
                <div onclick="" class="zoom-hover nb-shadow col-xl-2 col-lg-2 col-md-4 col-sm-4 mt-4">
                ...
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 mt-4 zoom-hover nb-shadow ">
                ...
                <div onclick="" class="col-xl-2 col-lg-2 col-md-4 col-sm-4 mt-4 zoom-hover nb-shadow">
