 <style>
   ...
   .login-form:focus~.form-login-placeholder {
           ...
           <div class="form-group">
             <div class="mb-5">
               <div class="input-group">
                 ...
                 <input type="text" name="username" class="form-control  login-form" id="username" aria-describedby="usernameHelp" required style="border-top-right-radius: 5px;border-bottom-right-radius:5px;" value="<?= $this->session->flashdata('username') ?>"><br>
             ...
             <div class="mb-3 mt-3">
               <div class="input-group">
                 ...
                 <input id="password" type="password" name="password" class="form-control login-form" required>
