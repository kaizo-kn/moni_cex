...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,600;1,700;1,800&family=Lobster&family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300;1,400;1,500;1,700&display=swap"
        rel="stylesheet">
    ...
    object-fit: cover;" src="<?= base_url() ?>assets/img/bg-pattern.png" alt="" srcset="">
        <ul class="circles">
            ...
            <li class='d-flex justify-content-center align-items-center'>
                <img style="object-fit: contain; width:5rem;height:auto"
                    src="<?= base_url() ?>assets/img/icons/Logo_PTPN4.png" alt="" srcset="">
            </li>
            <li></li>
            <li></li>
            <li></li>
            ...
            <li></li>
            <li class='d-flex justify-content-center align-items-center'>
                <img style="object-fit: contain; width:8rem;height:auto"
                    src="<?= base_url() ?>assets/img/icons/logo_holding.png" alt="" srcset="">
            </li>
        </ul>
        ...
        <div id="backdrop" style="width:100%;height:100%" class="d-flex justify-content-center align-items-center">
            <div class="justify-content-center h-100 w-75 d-flex align-items-center">
                <div id='main' style="backdrop-filter: blur(8px);border: solid 1px lightgrey;background-color:#ffffffa8"
                    class="p-4 rounded form-login">
                    <div class="section-title mb-3">
                        <div class="d-flex justify-content-center align-items-center">
                            <img class="mb-3" style="object-fit: contain; width:8rem;height:auto"
                                src="<?= base_url() ?>assets/img/icons/logo_holding.png" alt="" srcset="">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="mb-5">
                                <div class="input-group">
                                    ...
                                    <label for="username" id="username-placeholder"
                                        class="form-login-placeholder text-muted">Nama
                                        Pengguna</label>
                                </div>
                            </div>
                            <div class="mb-3 mt-3">
                                <div class="input-group">
                                    ...
                                    <input onblur="fieldFocus()"
                                        ...
                                        required style="border-top-right-radius: 5px;border-bottom-right-radius:5px;">
                                    <label for="password" id="password-placeholder"
                                        class="form-login-placeholder text-muted">Kata
                                        Sandi</label>
                                    <button
                            ...
                            <button type="submit"
                                class="btn mainbgc mt-4 float-end text-light fw-bold zoom-hover nb-shadow">Log
                                In</button>
                        </div>
                        <?php echo form_close(); ?>
                </div>
