            ...
            <table style="vertical-align: middle;" class="table table-bordered text-center align-items-center border-dark rounded">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>50</td>
                        <?php
                        echo "<td class='bg-info'>$lori_rebusan</td>";
                    ...
                    <tr>
                        ...
                        <td>100</td>
                        <?php
                        echo "<td class='bg-info'>$roda_lori</td>";
                    ...
                    <tr>
                        ...
                        <td>200</td>
                        <?php
                        echo "<td class='bg-info'>$bushing_lori</td>";
                    ...
                    <tr>
                        <td>2</td>
                        <td class="judul" style="text-align: left;">Timba - Timba Buah Masak (Fruit Elevator)
                        </td>
                        <td>Unit</td>
                        <td>1</td>
                        <?php
                        echo "<td class='bg-info'>$fruit_elevator</td>";
                    ...
                    <tr>
                        ...
                        <td>2</td>
                        <?php
                        echo "<td class='bg-info'>$as_thresher</td>";
                    ...
                    <tr>
                        ...
                        <td>2</td>
                        <?php
                        echo "<td class='bg-info'>$tromol_thresher</td>";
                    ...
                    <tr>
                        ...
                        <td>12</td>
                        <?php
                        echo "<td class='bg-info'>$body_cbc</td>";
                    ...
                    <tr>
                        ...
                        <td>20</td>
                        <?php
                        echo "<td class='bg-info'>$gantungan_cbc</td>";
                    ...
                    <tr>
                        ...
                        <td> 12 </td>
                        <?php
                        echo "<td class='bg-info'>$pedal_cbc</td>";
                    ...
                    <tr>
                        ...
                        <td>1</td>
                        <?php
                        echo "<td class='bg-info'>$body_polishdrum</td>";
                    ...
                    <tr>
                        ...
                        <td>2</td>
                        <?php
                        echo "<td class='bg-info'>$roll_body_polishdrum</td>";
                    ...
                    <tr>
                        ...
                        <td> 8 </td>
                        <?php
                        echo "<td class='bg-info'>$roll_bawah_polishdrum</td>";
                    ...
                    <tr>
                        ...
                        <td> 2 </td>
                        <?php
                        echo "<td class='bg-info'>$gear_polishdrum</td>";
                    ...
                    <tr>
                        ...
                        <td> 10</td>
                        <?php
                        echo "<td class='bg-info'>$dewatering_drum</td>";
                    ...
                    <tr>
                        ...
                        <td>12</td>
                        <?php
                        echo "<td class='bg-info'>$bottom_cone_inti</td>";
                    ...
                    <tr>
                        ...
                        <td> 12</td>
                        <?php
                        echo "<td class='bg-info'>$bottom_cone_cangkang</td>";
                    ...
                    <tr>
                        ...
                        <td> 6 </td>
                        <?php
                        echo "<td class='bg-info'>$vortex_finder</td>";
                    ...
                    <tr>
                        ...
                        <td> 6 </td>
                        <?php
                        echo "<td class='bg-info'>$feed_housing</td>";
                    ...
                    <tr>
                        ...
                        <td> 6 </td>
                        <?php
                        echo "<td class='bg-info'>$body_cyclone</td>";
                    ...
                    <tr>
                        ...
                        <td> 6 </td>
                        <?php
                        echo "<td class='bg-info'>$separating_cyclone</td>";
                    ...
                    <tr>
                        ...
                        <td> 6 </td>
                        <?php
                        echo "<td class='bg-info'>$box_control</td>";
