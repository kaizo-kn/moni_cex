...
<section id="home" class="pt-0 pb-2 rounded-bottom" style=" background-color: rgba(219, 219, 219, 0.836)!important;">
    ...
    <div id="cta" class="cta">
        <div style="backdrop-filter:blur(3px); width:100%;height:100%;" class="pt-4 pb-4">
            <div class="container" data-aos="zoom-in">
                <div class="row">
                    <div class=" text-center text-lg-start section-title">
                        <h2 style="text-shadow: 1px 1px 2px #000000;"  class="title text-light text-center ">Tentang Kami</h2>
                        <div class="mt-3">
                            <h4 style="text-shadow: 1px 1px 2px #000000;" class="subtitle text-light text-center mt-3">PMT Dolok Ilir</h4>
                            <h5 style="text-shadow: 1px 1px 2px #000000;" class="subtitle text-light text-center">Unit Perbengkelan PT Perkebunan Nusantara IV</h5>
                            <p style="text-shadow: 1px 1px 2px #000000;" class="text-light">Saat ini, kami mampu memenuhi seluruh permintaan perbaikan, pembuatan maupun pemasangan instalasi pabrik baik di dalam maupun di luar PTPN IV.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-xl-4 mt-lg-4 mt-md-4" data-aos="zoom-fade-up" data-aos-delay="200">
        <div class="row mb-0 pb-0 mt-lg-4 mt-xl-4 mt-sm-0">
            ...
            <div class="col-lg-8 col-md-8 col-sm-1 m-0 p-0">
                <div style="min-height:300px;background-image: url(<?= base_url() ?>assets/img/tenera_1.jpg);" class="d-flex justify-content-center align-items-center"></div>
            </div>
        </div>
                ...
                <div style="min-height:300px;" class="d-flex justify-content-center align-items-center">
                    <div class="text-center font-weight-bolder">
                        <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                            <div class="image_wrapper"><img class="scale-with-grid" src="<?=base_url('media/upload/icons/')?>value-icon-mini.png" alt="value-icon-mini" width="35" height="35"></div>
                        </div>
                        <br>
                        <br>
    ...
    <div class="container mt-xl-4 mt-lg-4 mt-md-0 mt-sm-0" data-aos="zoom-fade-up" data-aos-delay="200">
        <div class="row row-no-gap mb-0 pb-0">
            <div class="col-lg-8 col-md-8 col-sm-1 m-0 p-0">
                <div style="min-height:300px;background-image: url(<?= base_url() ?>assets/img/tenera_2.jpg);" class=" d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-4 col-lg-4 col-sm-1 m-0 p-3 pl-4   bg-light">
                <div style="min-height:300px;" class="d-flex justify-content-center align-items-center">
                    <div class="text-center">
                        <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                            <div class="image_wrapper"><img class="scale-with-grid" src="<?=base_url('media/upload/icons/')?>doc-sign-mini.png" alt="value-icon-mini" width="35" height="35"></div>
                        </div><br>
            ...
            <div class="col-lg-8 col-md-8 col-sm-1 pe-0  ps-xl-3 ps-lg-3 ps-md-3 ps-sm-0 ps-0">
                <div class="d-flex  flex-column align-items-center align-items-baseline ">
                    <div style="width: 100%;" class="row bg-dark align-self-center curpo zoom-hover">
                        <div class="col-lg-3 col-md-3 bg-secondary p-2 d-flex align-items-center justify-content-center"><img width="80px" height="80px" src="<?=base_url('media/upload/icons/')?>ICON-FOUNDRY.png" alt="" srcset=""></div>
                    ...
                    <div style="width: 100%;" class="row bg-dark align-self-center mt-3 curpo zoom-hover">
                        <div class="col-lg-3 col-md-3 bg-secondary p-2 d-flex align-items-center  justify-content-center"><img width="80px" height="80px" src="<?=base_url('media/upload/icons/')?>ICON-6-STANDARISASI.png" alt="" srcset=""></div>
                    ...
                    <div style="width: 100%;" class="row bg-dark align-self-center mt-3 curpo zoom-hover">
                        <div class="col-lg-3 col-md-3 bg-secondary p-2 d-flex align-items-center justify-content-center"><img width="80px" height="80px" src="<?=base_url('media/upload/icons/')?>ICON-LAIN-LAIN.png" alt="" srcset=""></div>
        ...
        <div class="row p-3 mt-4 mainbgc ">
            ...
            <div class="col-lg-4 col-md-4 d-flex justify-content-end">
                <img src="<?=base_url('assets/img/')?>pmt-trans.png" alt="" srcset="" height="200px" width="auto">
            </div>
        </div>
    </div>
</section>
