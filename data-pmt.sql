...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2022 at 06:23 AM
...
CREATE TABLE `catatan_info_harga` (
  ...
  `tanggal_update` varchar(40) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `catatan_info_harga` (`id`, `catatan`, `tanggal_update`) VALUES
(1, '1. Harga BELUM termasuk biaya pengiriman (transportasi).\r\n2. Harga sudah termasuk PPN 11% dan upah.\r\n3. Harga dapat berubah sewaktu-waktu sesuai kondisi pasar (antara lain: harga bahan, kurs, dll).\r\n4. Biaya belum termasuk tarif pekerja atau mandah di LUAR SUMATERA UTARA (luar wilayah).\r\n5. Pemesanan selain PTPN IV harus melalui persetujuan BoM (Board of Management).', 'Jumat, 30 Desember 2022 pukul 05.48 WIB');
...
(1, 'Jumat, 30 Desember 2022 pukul 06.04 WIB', 50, 1, 2, 1, 0, 20, 0, 1, 0, 0, 2, 2, 0, 1, 2, 0, 0, 0, 0, 20, 0),
...
--
-- Indexes for table `catatan_info_harga`
--
ALTER TABLE `catatan_info_harga`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `catatan_info_harga`
--
ALTER TABLE `catatan_info_harga`
